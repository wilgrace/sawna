...
--
-- Name: ensure_clerk_user(text, text, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.ensure_clerk_user(p_clerk_user_id text, p_email text, p_first_name text DEFAULT NULL::text, p_last_name text DEFAULT NULL::text) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  v_user_id uuid;
...
--
-- Name: ensure_clerk_user(text, text, text, text, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.ensure_clerk_user(p_clerk_user_id text, p_email text, p_first_name text DEFAULT NULL::text, p_last_name text DEFAULT NULL::text, p_organization_id uuid DEFAULT NULL::uuid) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
declare
  v_user_id uuid;
...
--
-- Name: trigger_instance_generation(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.trigger_instance_generation(template_id uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: clerk_users; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: saunas; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: session_instances; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: session_schedules; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: session_instances session_instances_new_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.session_instances
    ADD CONSTRAINT session_instances_new_pkey PRIMARY KEY (id);


--
-- Name: session_schedules session_schedules_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: clerk_users users_clerk_user_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: clerk_users users_email_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: clerk_users users_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_bookings_organization_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_bookings_session_instance_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_session_instances_new_start_time; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_session_instances_new_start_time ON public.session_instances USING btree (start_time);


--
-- Name: idx_session_instances_new_status; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_session_instances_new_status ON public.session_instances USING btree (status);


--
-- Name: idx_session_instances_new_template_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_session_instances_new_template_id ON public.session_instances USING btree (template_id);


--
-- Name: idx_session_instances_organization_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_session_schedules_day_time; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_session_schedules_template_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_session_templates_organization_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: saunas on_saunas_update; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER on_saunas_update BEFORE UPDATE ON public.saunas FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();


--
-- Name: session_instances on_session_instances_new_update; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER on_session_instances_new_update BEFORE UPDATE ON public.session_instances FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();


--
-- Name: session_instances on_session_instances_update; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER on_session_instances_update BEFORE UPDATE ON public.session_instances FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();


--
-- Name: session_schedules on_session_schedules_update; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER on_session_schedules_update BEFORE UPDATE ON public.session_schedules FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();


--
-- Name: session_templates on_session_templates_update; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER on_session_templates_update BEFORE UPDATE ON public.session_templates FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();
...
--
-- Name: bookings bookings_session_instance_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: session_instances session_instances_new_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.session_instances
    ADD CONSTRAINT session_instances_new_template_id_fkey FOREIGN KEY (template_id) REFERENCES public.session_templates(id) ON DELETE CASCADE;


--
-- Name: session_instances session_instances_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: session_schedules session_schedules_session_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: session_templates session_templates_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: session_templates session_templates_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: session_schedules Admins can manage schedules for their own templates; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: session_templates Enable insert for authenticated users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: session_templates Enable update for users based on created_by; Type: POLICY; Schema: public; Owner: postgres
--
...
CREATE POLICY "Users can create their own bookings" ON public.bookings FOR INSERT WITH CHECK ((user_id IN ( SELECT clerk_users.id
   FROM public.clerk_users
  WHERE (clerk_users.clerk_user_id = (auth.uid())::text))));


--
-- Name: bookings Users can delete their own bookings; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can delete their own bookings" ON public.bookings FOR DELETE USING ((user_id IN ( SELECT clerk_users.id
   FROM public.clerk_users
  WHERE (clerk_users.clerk_user_id = (auth.uid())::text))));
...
CREATE POLICY "Users can update their own bookings" ON public.bookings FOR UPDATE USING ((user_id IN ( SELECT clerk_users.id
   FROM public.clerk_users
  WHERE (clerk_users.clerk_user_id = (auth.uid())::text))));
...
CREATE POLICY "Users can view their own bookings" ON public.bookings FOR SELECT USING ((user_id IN ( SELECT clerk_users.id
   FROM public.clerk_users
  WHERE (clerk_users.clerk_user_id = (auth.uid())::text))));
...
--
-- Name: session_instances; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.session_instances ENABLE ROW LEVEL SECURITY;

--
-- Name: session_schedules; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION ensure_clerk_user(p_clerk_user_id text, p_email text, p_first_name text, p_last_name text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION ensure_clerk_user(p_clerk_user_id text, p_email text, p_first_name text, p_last_name text, p_organization_id uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION trigger_instance_generation(template_id uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE clerk_users; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE saunas; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE session_instances; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE session_schedules; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE session_templates; Type: ACL; Schema: public; Owner: postgres
--
