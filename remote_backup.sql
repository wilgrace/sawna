...
CREATE POLICY "Allow all" ON "public"."clerk_users" USING (true) WITH CHECK (true);



CREATE POLICY "Allow all" ON "public"."organizations" USING (true) WITH CHECK (true);



CREATE POLICY "Allow all users to read session_templates" ON "public"."session_templates" FOR SELECT TO "authenticated", "anon" USING (true);



CREATE POLICY "Allow service role full access" ON "public"."session_instances" USING (("auth"."role"() = 'service_role'::"text")) WITH CHECK (("auth"."role"() = 'service_role'::"text"));
...
CREATE POLICY "Service role can access all session templates" ON "public"."session_templates" TO "service_role" USING (true);



CREATE POLICY "Service role can manage all records" ON "public"."clerk_users" USING (("auth"."role"() = 'service_role'::"text"));



CREATE POLICY "Service role full access" ON "public"."bookings" USING (("auth"."role"() = 'service_role'::"text")) WITH CHECK (("auth"."role"() = 'service_role'::"text"));



CREATE POLICY "Service role full access" ON "public"."session_instances" USING (("auth"."role"() = 'service_role'::"text")) WITH CHECK (("auth"."role"() = 'service_role'::"text"));
...
CREATE POLICY "Users can insert their own bookings" ON "public"."bookings" FOR INSERT WITH CHECK (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Users can view their own data" ON "public"."clerk_users" FOR SELECT USING ((("auth"."uid"())::"text" = "clerk_user_id"));
